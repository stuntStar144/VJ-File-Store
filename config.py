...
SHORTLINK_URL = environ.get("SHORTLINK_URL", "seturl.in") # shortlink domain dev
SHORTLINK_API = environ.get("SHORTLINK_API", "c3772fe46867d29f913b1d8f3578f46b28fb5274") # shortlink api dev
